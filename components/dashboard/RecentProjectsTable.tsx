              ...
              <tr key={project.id} className="group hover:bg-white/[0.01] transition-colors">
                <td className="px-6 py-5">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm font-bold text-white group-hover:text-accent transition-colors">{project.name}</p>
                ...
                <td className="px-6 py-5 text-right">
                  <div className="flex items-center justify-end gap-3 text-muted-foreground">
                    <button className="hover:text-white transition-colors"><Pencil size={16} /></button>
